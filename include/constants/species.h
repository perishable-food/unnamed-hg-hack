...
#define MAX_SPECIES_PALDEAN_FORMS (SPECIES_REVAVROOM_CAPH)




// new perishable hack species
#define SPECIES_UNNAMED_HACK_START (MAX_SPECIES_PALDEAN_FORMS + 1)

#define SPECIES_MEGA_FLYGON (SPECIES_UNNAMED_HACK_START)
#define SPECIES_MEGA_GASTRODON (SPECIES_UNNAMED_HACK_START + 1)
#define SPECIES_MEGA_GASTRODON_EAST_SEA (SPECIES_UNNAMED_HACK_START + 2)
