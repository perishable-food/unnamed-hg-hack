...
PERISHABLE_DEPENDENCIES_DIR := $(ICONGFX_DEPENDENCIES_DIR)/perishable
ICONGFX_RAWDATA_DIR := rawdata/files_from_a020

ICONGFX_SRCS := $(wildcard $(ICONGFX_DEPENDENCIES_DIR)/*.png)
PERISHABLE_ICONGFX_SRCS := $(wildcard $(PERISHABLE_DEPENDENCIES_DIR)/*.png)
ICONGFX_OBJS := $(patsubst $(ICONGFX_DEPENDENCIES_DIR)/%.png,$(ICONGFX_DIR)/1_%.NCGR,$(ICONGFX_SRCS)) $(patsubst $(PERISHABLE_DEPENDENCIES_DIR)/%.png,$(ICONGFX_DIR)/2_%.NCGR,$(PERISHABLE_ICONGFX_SRCS))

$(ICONGFX_DIR)/1_%.NCGR:$(ICONGFX_DEPENDENCIES_DIR)/%.png
	$(GFX) $< $@ -clobbersize -version101

$(ICONGFX_DIR)/2_%.NCGR:$(PERISHABLE_DEPENDENCIES_DIR)/%.png
	$(GFX) $< $@ -clobbersize -version101
